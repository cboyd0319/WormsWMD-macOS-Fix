...
```text
WormsWMD-macOS-Fix-v1.6.5.zip: OK
```
...
| `INSTALL_REF` | Defaults to pinned release `v1.6.5` and exact commit verification; non-default refs require `WORMSWMD_ALLOW_UNPINNED_REF=1` |
