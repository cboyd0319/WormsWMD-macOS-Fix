...
require_qt_scan "component policy parser" "tools/qt_component_policy.py"
require_qt_scan "scanner" "tools/scan_qt_sbom.sh"
require_qt_scan "archive inspector dependency" "tools/inspect_archive.py"
require_qt_scan "shared scanner helpers" "scripts/common.sh"
require_qt_scan "scan classifier" "tools/ci_requires_qt_scan.sh"
require_qt_scan "changed-path producer" "tools/ci_changed_paths.sh"
