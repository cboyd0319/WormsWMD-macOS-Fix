...
- [Issue 10 backup stall plan](exec-plans/2026-06-18-issue-10-backup-stall.md)
  - fix for silent backup manifest work, diagnostics privacy, and
    adjacent backup edge cases.
- [Issue 11 game detection plan](exec-plans/2026-06-22-issue-11-game-detection.md)
  - fix for Bash 3.2 strict-mode game discovery and GOG install
    detection.
...
- [GitHub security deep dive](exec-plans/2026-08-26-github-security-deep-dive.md)
  - hardening of Actions, releases, hosted controls, secrets, and
...
- [Post-1.7.3 audit fixes plan](exec-plans/2026-07-01-post-173-audit-fixes.md)
  - follow-up for installer detection, rollback, launcher, docs,
