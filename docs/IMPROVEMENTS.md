...
| Keyboard input buffering | Some macOS 15.x installs can queue or delay keyboard input with the original Qt 5.3.2 runtime | Qt 5.15 refresh has been reported to resolve this on macOS 15.7.3 |
